...
namespace Etl.Core.Extraction
{
    public class Extractor
    {
        ...
        private readonly List<Extractor> _children;
        private readonly bool _isLast;

        public Extractor(LayoutDef layout, LayoutDirection parentDirection = LayoutDirection.Row, bool isLast = false, int hierarchy = 0)
        {
            _layout = layout;
