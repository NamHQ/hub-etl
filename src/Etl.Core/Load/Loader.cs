...
namespace Etl.Core.Load
{
    ...
    {
        void Initalize(object args, string inputFile, IReadOnlyCollection<TransformFieldDef> fields);
    ...
    {
        protected virtual void Initalize(TDef args, string inputFile, IReadOnlyCollection<TransformFieldDef> fields) { }
        void ILoader.Initalize(object config, string inputFile, IReadOnlyCollection<TransformFieldDef> fields)
